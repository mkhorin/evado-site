...
jQuery('.navbar-target').append(`<div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand brand-en" href="${window.indexLink || '../'}"></a>
      </div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          <li><a class="dark-btn" href="${window.languageLink || '../ru'}">${window.languageLabel || 'RU'}</a></li>
        </ul>
      </div>
    </div>`);
...
(function($) {
    const items = window.sideMenuItems;
...
(function($) {
    const items = window.codeMap[activePathName];
